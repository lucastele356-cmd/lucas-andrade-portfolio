export const projetos = {
  tp: {
    titulo: 'TP Consultoria',
    categoriaLabel: 'Identidade visual · Consultoria de benefícios',
    meta: [
      { label: 'Cliente', value: 'TP Consultoria' },
      { label: 'Categoria', value: 'Corporativo' },
      { label: 'Serviços', value: 'Identidade visual, sistema gráfico, aplicações' },
      { label: 'Ano', value: '2026' },
    ],
    ctaLabel: 'Ver mais projetos',
    ctaHref: '/#projetos',
    blocos: [
      {
        tipo: 'texto',
  ...
  anthony: {
    titulo: 'Anthony Carbert',
    categoriaLabel: 'Identidade visual · Artista musical',
    meta: [
      { label: 'Cliente', value: 'Anthony Carbert' },
      { label: 'Categoria', value: 'Música' },
      { label: 'Serviços', value: 'Identidade visual, merchandising, materiais de palco' },
      { label: 'Ano', value: '2026' },
    ],
    ctaLabel: 'Ver mais projetos',
    ctaHref: '/#projetos',
  ...
  solve: {
    titulo: 'Solve Scale',
    categoriaLabel: 'Identidade visual · Marketing empresarial',
    meta: [
      { label: 'Cliente', value: 'Solve Scale' },
      { label: 'Categoria', value: 'Empresa · Marketing' },
      { label: 'Serviços', value: 'Identidade visual, sistema de marca, aplicações' },
      { label: 'Ano', value: '2026' },
    ],
    ctaLabel: 'Ver mais projetos',
    ctaHref: '/#projetos',
    blocos: [
      {
        tipo: 'texto',
        html: 'A Solve Scale nasce de uma constatação simples: o maior problema de qualquer empresa não é falta de estratégia, é falta de escala. Atuamos com foco absoluto em performance e identidade para negócios que competem contra players muito maiores e vencem pela qualidade da entrega, não pelo tamanho do caixa. Onde o mercado se acostumou com o óbvio, a <strong>Solve Scale constrói diferenciação real</strong>: em posicionamento, em imagem, em resultado.',
      },
      ...
      { tipo: 'imagem', src: '/projetos/solve/aplicacao.webp', alt: 'Moletom com a identidade da Solve Scale aplicada' },
      { tipo: 'imagem', src: '/projetos/solve/garrafas.webp', alt: 'Garrafas e portfólio de apresentação da Solve Scale' },
      { tipo: 'imagem', src: '/projetos/solve/fachada.webp', alt: 'Placa de sinalização e fachada com a marca Solve Scale' },
      { tipo: 'imagem', src: '/projetos/solve/recepcao.webp', alt: 'Recepção com parede de marca da Solve Scale' },
      {
        tipo: 'texto',
        html: 'Pouco depois do lançamento, o placar simbólico da marca virou realidade: <strong>500 mil reais faturados</strong> sob a nova identidade.',
      },
      { tipo: 'imagem', src: '/projetos/solve/premio.webp', alt: 'Quadro comemorativo "500K Faturados" da Solve Scale' },
      { tipo: 'imagem', src: '/projetos/solve/check-3d.webp', alt: 'Render em vidro do símbolo da Solve Scale' },
    ],
  },
  informada: {
    titulo: 'Instituto Escola Informada',
    categoriaLabel: 'Identidade visual · Instituto de proteção infantil',
    meta: [
      { label: 'Cliente', value: 'Instituto Escola Informada' },
      { label: 'Categoria', value: 'Institucional' },
      { label: 'Serviços', value: 'Identidade visual, papelaria, campanha de conscientização' },
      { label: 'Ano', value: '2026' },
    ],
    ctaLabel: 'Ver mais projetos',
    ctaHref: '/#projetos',
